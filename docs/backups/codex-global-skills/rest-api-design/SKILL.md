...
description: Use when designing, reviewing, documenting, or hardening REST APIs, including resource modeling, HTTP semantics, pagination, versioning, validation, or endpoint security.
---
