...
type UseExpenseTicketLineDetailTopbarActionsArgs = {
  busy: boolean;
  modalOpen: boolean;
  isEditing: boolean;
...
// Coordinates topbar icon state and dispatch actions for ticket line detail.
export const useExpenseTicketLineDetailTopbarActions = ({
  busy,
  modalOpen,
  isEditing,
  canEditTicket,
