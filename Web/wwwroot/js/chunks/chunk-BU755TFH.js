...
var RemoteSearchCombobox = ({
  ...
  const hasMoreRef = (0, import_react.useRef)(false);
  const loadedSearchTermRef = (0, import_react.useRef)("");
  const loadingRef = (0, import_react.useRef)(false);
  const runLoadMoreRef = (0, import_react.useRef)(null);
  ...
  const runOpenSearch = (0, import_react.useCallback)(async () => {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "absolute inset-y-0 right-0 flex items-center gap-1 pr-2", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "button",
                {
                  ...
                  disabled: readOnlyMode,
                  children: open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronUpSvg, { className: "size-5" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDownSvg, { className: "size-5" })
                }
              )
            ] })
          ]
