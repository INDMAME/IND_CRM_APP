...
const ExpenseTicketLinkBulkSummary = ({ result }: ExpenseTicketLinkBulkSummaryProps) => {
  ...
  return (
    <div className="glass-panel shadow-card space-y-3 rounded-[var(--radius-xl)] border border-slate-200 bg-white/95 p-3">
      <div>
      ...
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
        {summaryRows.map((item) => (
          <div key={item.key} className="rounded-[var(--radius-xl)] border border-slate-200 bg-slate-50 px-3 py-2 text-center">
