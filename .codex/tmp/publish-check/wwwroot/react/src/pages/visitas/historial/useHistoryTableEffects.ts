...
type UseHistoryTableEffectsArgs = {
...
// Owns tooltip, ellipsis, and pixel effects for history timeline cards.
export const useHistoryTableEffects = ({
  containerRef,
  errorMessage,
  items,
  resolveClickableCard,
}: UseHistoryTableEffectsArgs) => {
