(() => {
  ...
  var VisitTypeCombobox = ({ options = [], targetId = "visitType" }) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "relative z-[140000]", ref: containerRef, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "relative mt-1", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(FloatingList, { anchorRef: boxRef, open, zIndex: 36e4, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { ref: listRef, role: "listbox", "aria-label": indT("Visits_Detail_VisitType_Label", "Visit type"), children: filtered.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "relative cursor-default select-none px-4 py-2 text-slate-700", children: indT("Dropdown_NoResults", "No results") }) : filtered.map((opt, idx) => {
